  ...
  module Ads
    module GoogleAds
      module V3
        module Services
          # Request message for
          # {Google::Ads::GoogleAds::V3::Services::CampaignExtensionSettingService::Client#get_campaign_extension_setting CampaignExtensionSettingService.GetCampaignExtensionSetting}.
          ...
          # Request message for
          # {Google::Ads::GoogleAds::V3::Services::CampaignExtensionSettingService::Client#mutate_campaign_extension_settings CampaignExtensionSettingService.MutateCampaignExtensionSettings}.
