...
class GarbageGemPresenterTest < PresenterTest
  ...
  def test_garbage
    ...
    assert_equal ["google/api/field_behavior.proto", "google/api/resource.proto", "google/protobuf/any.proto", "google/protobuf/duration.proto", "google/protobuf/empty.proto", "google/rpc/status.proto", "google/longrunning/operations.proto", "google/protobuf/timestamp.proto", "garbage/garbage.proto", "garbage/resource_names.proto", "google/iam/v1/options.proto", "google/type/expr.proto", "google/iam/v1/policy.proto", "google/iam/v1/iam_policy.proto"], presenter.proto_files.map(&:name)
